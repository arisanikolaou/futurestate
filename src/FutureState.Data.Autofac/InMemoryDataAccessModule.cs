...
{
    /// <summary>
    /// Similar to the orm lite data access module for memory resident databases. Registers InMemory repositories as the
    /// default implementation
    /// for all repositories and linq readers.
    /// </summary>
    /// <remarks>
    /// All types resolved have a 'single instance' life time.
    /// </remarks>
