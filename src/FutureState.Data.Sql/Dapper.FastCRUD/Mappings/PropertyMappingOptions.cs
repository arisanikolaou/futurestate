...
namespace Dapper.FastCrud.Mappings
{
    ...
    public enum PropertyMappingOptions
    {
        ...
        /// <summary>
        ///     This is a database generated property. Database generated key properties will be excluded from <c>Insert</c>, and
        ///     their values will be updated on the entity once the insertion has completed.
        /// </summary>
        /// <summary>
        ...
        /// <summary>
        ///     Useful for partial updates and identity columns, a property marked with this option will be excluded from any
