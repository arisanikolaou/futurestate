...
namespace Dapper.FastCrud.Formatters
{
    ...
    public sealed class SqlStatementFormatter : IFormatProvider, ICustomFormatter
    {
        ...
        internal SqlStatementFormatter(EntityDescriptor mainEntityDescriptor, EntityMapping mainEntityMapping,
            ISqlBuilder mainEntitySqlBuilder, bool forceColumnAsTableColumnResolution)
        {
            _forceColumnAsTableColumnResolution = forceColumnAsTableColumnResolution;
            MainEntityType = mainEntityDescriptor.EntityType;
            MainEntityDescriptor = mainEntityDescriptor;
            MainEntitySqlBuilder = mainEntitySqlBuilder;
            MainEntityMapping = mainEntityMapping;
        }
