...
namespace Dapper.FastCrud
{
    ...
    public static class DapperExtensions
    {
        ...
        /// <param name="statementOptions">
        ///     Optional statement options (usage: statement =>
        ///     statement.SetTimeout().AttachToTransaction()...)
        /// </param>
        ...
        /// <summary>
        ///     Deletes all the records in the table or a range of records if a conditional clause was set up in the statement
        ///     options.
        /// </summary>
        /// <typeparam name="TEntity">Entity Type</typeparam>
        /// <param name="connection">Database connection.</param>
        ...
        /// <summary>
        ///     Counts all the records in a table or a range of records if a conditional clause was set up in the statement
        ///     options.
        /// </summary>
        /// <typeparam name="TEntity">Entity type</typeparam>
        /// <param name="connection"></param>
