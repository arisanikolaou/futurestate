...
namespace Dapper.FastCrud.SqlStatements
{
        ...
        : RelationshipSqlStatements<TMainEntity>
    {
        ...
        ///     Default constructor
        /// </summary>
        public FiveEntitiesRelationshipSqlStatements(
            FourEntitiesRelationshipSqlStatements
        ...
        /// </summary>
        public override ISqlStatements<TMainEntity> CombineWith<TFifthJoinedEntity>(
            ISqlStatements<TFifthJoinedEntity> joinedEntitySqlStatements)
        {
            return
                new SixEntitiesRelationshipSqlStatements
                <TMainEntity, TFirstJoinedEntity, TSecondJoinedEntity, TThirdJoinedEntity, TFourthJoinedEntity,
                    TFifthJoinedEntity>(this, joinedEntitySqlStatements.SqlBuilder);
        }
