...
namespace Dapper.FastCrud.SqlStatements
{
        ...
        : RelationshipSqlStatements<TMainEntity>
    {
        ...
        public ThreeEntitiesRelationshipSqlStatements(
            TwoEntitiesRelationshipSqlStatements<TMainEntity, TFirstJoinedEntity> relationshipSqlStatements,
        ...
        /// </summary>
        public override ISqlStatements<TMainEntity> CombineWith<TThirdJoinedEntity>(
            ISqlStatements<TThirdJoinedEntity> joinedEntitySqlStatements)
        {
            return
                new FourEntitiesRelationshipSqlStatements
                    <TMainEntity, TFirstJoinedEntity, TSecondJoinedEntity, TThirdJoinedEntity>(this,
