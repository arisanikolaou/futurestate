...
namespace Dapper.FastCrud.SqlStatements
{
    ...
    internal class TwoEntitiesRelationshipSqlStatements<TMainEntity, TFirstJoinedEntity> :
        RelationshipSqlStatements<TMainEntity>
    {
        ...
        public TwoEntitiesRelationshipSqlStatements(ISqlStatements<TMainEntity> mainEntitySqlStatements,
        ...
        /// </summary>
        public override ISqlStatements<TMainEntity> CombineWith<TSecondJoinedEntity>(
            ISqlStatements<TSecondJoinedEntity> joinedEntitySqlStatements)
        {
            return new ThreeEntitiesRelationshipSqlStatements<TMainEntity, TFirstJoinedEntity, TSecondJoinedEntity>(
                this, joinedEntitySqlStatements.SqlBuilder);
        }
        ...
        {
            return connection
                .QueryAsync<TMainEntity, TFirstJoinedEntity, RelationshipEntityInstanceIdentity<TMainEntity>>(
                    statement,
                    (mainEntity, joinedEntity) =>
                    {
                        var mainEntityIdentity = relationshipInstanceBuilder.RegisterResultSetRowInstance(mainEntity);
