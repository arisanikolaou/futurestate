...
namespace Dapper.FastCrud.SqlStatements
{
        ...
        : RelationshipSqlStatements<TMainEntity>
    {
        ...
        ///     Default constructor
        /// </summary>
        public FourEntitiesRelationshipSqlStatements(
            ThreeEntitiesRelationshipSqlStatements<TMainEntity, TFirstJoinedEntity, TSecondJoinedEntity>
                relationshipSqlStatements, GenericStatementSqlBuilder joinedEntitySqlStatements)
        ...
        /// </summary>
        public override ISqlStatements<TMainEntity> CombineWith<TFourthJoinedEntity>(
            ISqlStatements<TFourthJoinedEntity> joinedEntitySqlStatements)
        {
            return
                new FiveEntitiesRelationshipSqlStatements
            ...
            RelationshipEntityInstanceBuilder relationshipInstanceBuilder)
        {
            return connection
                .Query
                <TMainEntity, TFirstJoinedEntity, TSecondJoinedEntity, TThirdJoinedEntity,
