...
namespace Dapper.FastCrud
{
    ...
    public static class Sql
    {
        ...
        /// <summary>
        ///     Returns a parameter formatter for the name of the database column attached to the specified property of the main
        ///     entity.
        ...
        /// <summary>
        ///     Returns a parameter formatter for the combined table and column attached to the specified property of the main
        ///     entity.
        ///     If you wish to resolve the column name of another entity, please use the generic overload instead.
        /// </summary>
        /// <param name="propertyName">Name of the property (e.g. <code>nameof(entity.propname)</code>)</param>
        ...
        {
            Requires.NotNullOrEmpty(propertyName, nameof(propertyName));
            return new SqlEntityFormattableParameter<TEntity>(SqlParameterElementType.Column, propertyName,
                entityMappingOverride);
        }
        ...
        /// <param name="propertyName">Name of the property (e.g. <code>nameof(entity.propname)</code>)</param>
        /// <param name="entityMappingOverride">Overrides the entity mapping used in the query method.</param>
        public static IFormattable TableAndColumn<TEntity>(string propertyName,
            EntityMapping entityMappingOverride = null)
        {
            Requires.NotNullOrEmpty(propertyName, nameof(propertyName));
            return new SqlEntityFormattableParameter<TEntity>(SqlParameterElementType.TableAndColumn, propertyName,
                entityMappingOverride);
        }
    }
}