...
namespace Dapper.FastCrud.Configuration.StatementOptions.Aggregated
{
    ...
    internal abstract class AggregatedSqlStatementOptions<TEntity>
    {
        ...
        {
            CommandTimeout = OrmConfiguration.DefaultSqlStatementOptions.CommandTimeout;
            RelationshipOptions = new Dictionary<Type, AggregatedRelationalSqlStatementOptions>();
            SqlStatementsFactoryChain = () => OrmConfiguration.GetSqlStatements<TEntity>(EntityMappingOverride);
        }
