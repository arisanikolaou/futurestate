...
namespace Dapper.FastCrud.Configuration.StatementOptions.Builders
{
    ...
    internal class SqlRelationOptionsBuilder<TReferencedEntity>
        :
            AggregatedRelationalSqlStatementOptionsBuilder
            <TReferencedEntity, ISqlRelationOptionsBuilder<TReferencedEntity>>,
            ISqlRelationOptionsBuilder<TReferencedEntity>
    {
