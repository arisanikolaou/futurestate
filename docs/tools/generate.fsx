...
let githubLink = "https://github.com/Update GitHome in build.fsx/FState"

// Specify more information about your project
let info =
  [ "project-name", "FState"
    "project-author", "Aris Nikolaou"
    "project-summary", "FState"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/FState" ]
